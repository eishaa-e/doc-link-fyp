...
const AppointmentListItem = ({ appointment }) => {
  ...
  return (
    <div className="flex items-center my-5 bg-white p-4 rounded-xl">
      ...
      <button
        type="button"
        className=" bg-fuchsia-200 text-sm text-center font-bold rounded-lg flex justify-center items-center gap-1 px-2 py-2 focus:ring-4 focus:outline-none focus:ring-purple-200"
        id="user-menu-button"
        aria-expanded="false"
      ...
      {isDropdownOpen && (
        <div
          onMouseEnter={openDropdown}
          onMouseLeave={closeDropdown}
          className="z-100 p-2 w-50 fixed text-base list-none bg-fuchsia-100 rounded-lg divide-y divide-light-orchid shadow"
          id="user-dropdown"
        >
