...
const AppointmentListItem = ({ appointment, onUpdate, isPast }) => {
  ...
  return (
    <div
      className="flex items-center my-5 bg-white p-4 rounded-xl shadow-md shadow-teal-100">
      ...
      {appointment.status === "CANCELLED" || isPast ? (
        ...
        <div className="relative">
          <button
            type="button"
            className="bg-teal-500 hover:bg-teal-800 text-sm ml-4 text-center font-bold rounded-lg flex justify-center items-center gap-1 px-1 py-1 focus:ring-4 focus:outline-none focus:ring-purple-200"
            id="user-menu-button"
            aria-expanded="false"
