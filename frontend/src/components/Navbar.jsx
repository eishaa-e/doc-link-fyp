                ...
                <div className="flex items-center flex-col md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    {!isUserLoggedIn ? (<div>
                        ...
                        {isDropdownOpen && (<div
                            ...
                            id="user-dropdown">
                            {userInfo && <div className="px-4 py-3">
                                    <span
                            ...
                            <ul className="py-2" aria-labelledby="user-menu-button">
                                <li>
                                    <Link to={
                                        currentUserRole === 'doctor' ? '/doctor/profile-form' : '/patient/profile-form'
                                    }
                                          className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Update
                                        Profile</Link>
                                </li>
                                <li>
                                    <Link to=""
