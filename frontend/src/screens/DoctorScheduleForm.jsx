...
const DoctorScheduleForm = () => {
    ...
    return (
        <div
            className="w-full max-w-7xl flex flex-col justify-center items-center bg-fuchsia-100 rounded-lg shadow-lg p-6 mx-auto my-10">
            <h2 className="text-2xl text-center font-bold my-5">Manage Availability Schedule</h2>
