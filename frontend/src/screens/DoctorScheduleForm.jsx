    ...
    return (
        <div className="w-full bg-gray-100 py-10">
            <div
                ...
                <div
                    className="w-full flex justify-start items-start gap-6 p-10 bg-white rounded-xl shadow-xl shadow-light-orchid">
                    ...
                    <div className="flex justify-start flex-col gap-5 my-5 px-5 border-r-2 border-gray-300">
                        ...
                        {daysOfWeek.map((day) => (
                            <button
                                ...
                                className={`py-3 px-4 rounded-xl border ${selectedDay === day ? "bg-fuchsia-500 text-white" : "bg-fuchsia-100"} hover:bg-fuchsia-400 hover:text-white shadow-lg shadow-light-orchid`}
                            >
                                {day}
                            </button>
                        ))}
                            ...
                            <div className="w-full grid grid-cols-12 gap-3 mt-4">
                                {availableSlots.map((slot, index) => (
                                    <button
                                        ...
                                        className={`py-3 px-4 rounded-xl border shadow-lg my-4 ${selectedSlots[selectedDay]?.some((s) => s.startTime === convertTo24Hour(slot)) ? "bg-fuchsia-500 text-white shadow-light-orchid" : "bg-fuchsia-100"} hover:bg-fuchsia-400 hover:text-white`}
                ...
                <div className="w-full bg-white my-10 p-10 shadow-xl shadow-light-orchid rounded-xl">
                    <h2 className="text-2xl font-bold text-center flex flex-col justify-center items-center">
                        Selected Slots
                        <hr className="w-1/5 h-1 bg-gray-400 mt-2"/>
                    </h2>
                        ...
                        <div key={day} className="w-full mt-6">
                            ...
                            <div className="grid grid-cols-12 gap-3 mt-2">
                                {selectedSlots[day].map((slot, idx) => (
                                    <div
                                        key={idx}
                                        className="flex justify-between items-center bg-fuchsia-100 border rounded-lg p-2 shadow-lg shadow-light-orchid"
                                    >
                                        <p>
                ...
                <button
                    ...
                    className="mt-6 px-6 py-3 bg-fuchsia-500 text-white rounded-full hover:bg-fuchsia-400"
                >
                    Save Schedule
                </button>
                ...
                <button
                    onClick={() => navigate(-1)}
                    className="mt-6 px-6 py-3 bg-fuchsia-100 text-black rounded-full shadow-lg hover:bg-fuchsia-400 hover:text-white"
                >
                    Back
                </button>
            </div>
