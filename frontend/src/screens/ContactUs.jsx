...
const ContactUs = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center bg-gray-100 py-20 p-4">
      <div
        className="w-full max-w-6xl bg-teal-100 rounded-lg shadow-xl shadow-teal-100 flex flex-col md:flex-row overflow-hidden">
        <div className="bg-teal-500 w-full md:w-1/2 p-8 text-white">
        ...
        <div className="w-full md:w-1/2 py-8 px-16">
          ...
          <form>
              ...
              <div className="flex space-x-4">
                <label className="inline-flex items-center">
                  <input
                    ...
                    className="form-radio text-teal-500 focus:ring-teal-500 focus:ring-2"
                    checked
                  />
            ...
            <div className="text-center">
              <button
                type="submit"
                className="bg-teal-500 hover:bg-teal-800 text-white py-2 px-6 rounded-full"
              >
                Send Message
              </button>
            </div>
