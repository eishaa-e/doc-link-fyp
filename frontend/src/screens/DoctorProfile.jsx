...
const DoctorProfile = () => {
  ...
  const [viewPmdc, setViewPmdc] = useState(false);
  ...
  const togglePmdcCertificate = () => {
    setViewPmdc(!viewPmdc);
  };
          ...
          >
            <div className="relative w-full max-w-md p-4 mx-auto bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="p-6 space-y-6">
                <form className="w-full flex flex-col justify-center items-center p-5 rounded-xl">
          ...
          >
            <div className="relative w-full max-w-md p-4 mx-auto bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="p-2 space-y-6">
                <div className="w-full flex flex-col justify-center items-center p-2 rounded-xl">
                  <img
                    src={doctor.pmdcCertificate}
                    alt="PMDC Certificate"
