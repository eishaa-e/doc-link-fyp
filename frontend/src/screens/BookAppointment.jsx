    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6">
            ...
            <div className="flex w-full max-w-6xl justify-between items-start gap-10">
                <div
                    className="w-full min-h-[300px] bg-white shadow-xl shadow-light-orchid rounded-lg p-6 mb-8 flex justify-center items-center gap-12">
                    <div
                        ...
                        <img
                            ...
                            alt="Patient"
                            className="w-32 h-32 rounded-full mr-4 mb-5 shadow-xl shadow-light-orchid"
                        />
            ...
            <div className="grid grid-cols-2 gap-10 w-full max-w-6xl">
                ...
                <div
                    className="bg-white shadow-xl shadow-light-orchid rounded-lg p-6 mb-8 flex flex-col justify-center items-center">
                        ...
                        {filteredSlots.length > 0 ? (
                            filteredSlots.map((slot, index) => (
                                <button
                                    ...
                                    className={`py-2 px-4 rounded-xl border ${selectedSlot === slot ? "bg-fuchsia-500 text-white" : "bg-fuchsia-100"} hover:bg-fuchsia-300`}
                                >
                                    {slot.startTime}
                                </button>
                            ))
            ...
            {/*<div*/}
            {/*    className="w-full flex flex-col justify-start items-center max-w-6xl bg-white rounded-lg shadow-xl shadow-light-orchid p-6">*/}
