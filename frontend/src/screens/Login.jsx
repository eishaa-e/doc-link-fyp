            ...
            <div
                ...
                <div className="flex-1 flex flex-col justify-center p-8">
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <h2 className="text-4xl font-bold text-center mb-5 text-fuchsia-500">DOC LINK</h2>
                    </div>
                    <form onSubmit={handleSubmit} className="w-full">
                        ...
                        <div className="flex items-center justify-center gap-4 mb-5">
                            <div>
                                ...
                                />
                                <label htmlFor="doctor" className="ms-2 text-sm font-medium text-gray-900">
                                    Doctor
                                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    className="w-4 h-4 text-fuchsia-500 bg-gray-100 border-gray-300 focus:ring-fuchsia-500"
                                />
                                <label htmlFor="patient" className="ms-2 text-sm font-medium text-gray-900">
                                    Patient
                                </label>
                            </div>
                        </div>
