...
const UpdatePassword = () => {
  ...
  return (
    <div className="w-full py-20 bg-gray-100 flex justify-center gap-16 items-center">
      <form
      ...
      >
        ...
        <button
          type="submit"
          className="w-full text-white bg-teal-500 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-full text-sm px-5 py-2.5 text-center"
        >
          Update Password
        </button>
      </form>
