...
router.get("/patients/:patientId", authenticateToken, appointmentController.getAppointmentsByPatient);
router.get("/doctors/:doctorId", authenticateToken, appointmentController.getAppointmentsByDoctor);
